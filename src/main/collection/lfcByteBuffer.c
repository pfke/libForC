...
IMPL_API__wRET__w_0PARAM(lfcByteBuffer, capacity, size_t)
IMPL_API__wRET__w_0PARAM(lfcByteBuffer, isEmpty, int)
IMPL_API__wRET__w_0PARAM(lfcByteBuffer, nonEmpty, int)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, read_int8, size_t, int8_t *)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, read_int16, size_t, int16_t *)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, read_int32, size_t, int32_t *)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, read_int64, size_t, int64_t *)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, read_uint8, size_t, uint8_t *)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, read_uint16, size_t, uint16_t *)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, read_uint32, size_t, uint32_t *)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, read_uint64, size_t, uint64_t *)
IMPL_API__wRET__w_2PARAM(lfcByteBuffer, read_int8ptr, size_t, size_t, int8_t *)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, write_int8, size_t, int8_t)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, write_int16, size_t, int16_t)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, write_int32, size_t, int32_t)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, write_int64, size_t, int64_t)
IMPL_API__wRET__w_1PARAM(lfcByteBuffer, write_uint8, size_t, uint8_t)
