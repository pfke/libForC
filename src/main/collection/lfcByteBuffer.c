...
lfcOOP_accessor(lfcByteBuffer, capacity, size_t)
lfcOOP_accessor(lfcByteBuffer, isEmpty, int)
lfcOOP_accessor(lfcByteBuffer, nonEmpty, int)
lfcOOP_accessor(lfcByteBuffer, read_int8, size_t, int8_t *)
lfcOOP_accessor(lfcByteBuffer, read_int16, size_t, int16_t *)
lfcOOP_accessor(lfcByteBuffer, read_int32, size_t, int32_t *)
lfcOOP_accessor(lfcByteBuffer, read_int64, size_t, int64_t *)
lfcOOP_accessor(lfcByteBuffer, read_uint8, size_t, uint8_t *)
lfcOOP_accessor(lfcByteBuffer, read_uint16, size_t, uint16_t *)
lfcOOP_accessor(lfcByteBuffer, read_uint32, size_t, uint32_t *)
lfcOOP_accessor(lfcByteBuffer, read_uint64, size_t, uint64_t *)
lfcOOP_accessor(lfcByteBuffer, read_int8ptr, size_t, size_t, int8_t *)
lfcOOP_accessor(lfcByteBuffer, write_int8, size_t, int8_t)
lfcOOP_accessor(lfcByteBuffer, write_int16, size_t, int16_t)
lfcOOP_accessor(lfcByteBuffer, write_int32, size_t, int32_t)
lfcOOP_accessor(lfcByteBuffer, write_int64, size_t, int64_t)
lfcOOP_accessor(lfcByteBuffer, write_uint8, size_t, uint8_t)
lfcOOP_accessor(lfcByteBuffer, write_uint16, size_t, uint16_t)
lfcOOP_accessor(lfcByteBuffer, write_uint32, size_t, uint32_t)
lfcOOP_accessor(lfcByteBuffer, write_uint64, size_t, uint64_t)
lfcOOP_accessor(lfcByteBuffer, write_int8ptr, size_t, size_t, const int8_t *)
lfcOOP_accessor(lfcByteBuffer, toArray, size_t, int8_t **)
