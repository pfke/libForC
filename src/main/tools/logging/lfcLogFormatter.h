#ifndef LIBFORC_TOOLS_LOGGING_LOGFORMATTER_H_
#define LIBFORC_TOOLS_LOGGING_LOGFORMATTER_H_
...
/**
 * Formattierung des Log anhand der Format-Vorgabe:
 *
 *  Field Name 	    pattern
 *   message         %m
 *
 ...
 * @param log log item
 * @return !NULL .. ist ein char buf der freigegeben werden muss
 *         NULL .. irgendein Fehler
 */
...
#endif /*--- #ifndef LIBFORC_TOOLS_LOGGING_LOGFORMATTER_H_ ---*/
