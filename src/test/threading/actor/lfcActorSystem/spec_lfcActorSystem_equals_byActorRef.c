...
Test(
    ...
    lfcActorRef_t *tto_actor = lfcActorSystem_createActor(tto_system, "actor_01", my_receive_fn_cb_actor);
...
Test(
    ...
    lfcActorRef_t *tto_actor = lfcActorSystem_createActor(tto_system_02, "actor_01", my_receive_fn_cb_actor);
