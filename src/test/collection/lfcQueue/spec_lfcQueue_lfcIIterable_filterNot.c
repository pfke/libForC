...
#define TEST_SUITE_NAME               lfcQueue__IIterable_filterNot
...
Test(
    ...
    lfcQueue_t *tto = lfcIIterable_filterNot(src, lfcifoc_DONT_FREE_OLD_COLLECION, lambda(int, (void *item isAnIncognito_param) {
...
Test(
    ...
    lfcQueue_t *src = lfcQueue_ctor();
    lfcQueue_t *tto = lfcIIterable_filterNot(src, lfcifoc_FREE_OLD_COLLECION, lambda(int, (void *item isAnIncognito_param) {
        return !strncmp(item, "1", 1);
    }));
...
Test(
    ...
    should_be_same_ptr_wText(lfcQueue_dequeue(tto), "2", "soll 1 Element gefiltert haben");
...
Test(
    ...
    should_be_same_ptr_wText(lfcQueue_dequeue(tto), "2", "soll 2 Element gefiltert haben");
...
Test(
    ...
    should_be_same_ptr_wText(lfcQueue_dequeue(tto), (void *)1, "soll das richtige 1. Element haben");
...
Test(
    ...
    should_be_same_ptr_wText(lfcQueue_dequeue(tto), (void *)3, "soll das richtige 2. Element haben");
...
Test(
    ...
    lfcQueue_methods()->dequeue(tto);
    lfcQueue_methods()->dequeue(tto);
    should_be_same_ptr_wText(lfcQueue_dequeue(tto), (void *)5, "soll das richtige 3. Element haben");
