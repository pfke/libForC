...
#define TEST_SUITE_NAME               spec_lfcByteBuffer_read_uint32
...
Test(
    ...
    should_be_same_int(lfcByteBuffer_read_uint32(tto, NULL), 0);
...
Test(
    ...
    lfcByteBuffer_t *tto = lfcByteBuffer_ctor();
    lfcByteBuffer_write_uint32(tto, 125);

    should_be_same_int(lfcByteBuffer_read_uint32(tto, NULL), 4);
