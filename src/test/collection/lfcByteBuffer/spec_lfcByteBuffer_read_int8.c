...
#define TEST_SUITE_NAME               spec_lfcByteBuffer_read_int8
...
Test(
    ...
    should_be_same_int(lfcByteBuffer_read_int8(tto, NULL), 0);
...
Test(
    ...
    should_be_same_int(lfcByteBuffer_read_int8(tto, NULL), 1);
...
Test(
    ...
    int8_t result = 0;
    lfcByteBuffer_t *tto = lfcByteBuffer_ctor();
    lfcByteBuffer_write_int8(tto, 114);

    lfcByteBuffer_read_int8(tto, &result);
    should_be_same_int(result, 114);
