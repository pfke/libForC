...
#define TEST_SUITE_NAME               spec_lfcByteBuffer_read_int16
...
Test(
    ...
    should_be_same_int(lfcByteBuffer_read_int16(tto, NULL), 0);
...
Test(
    ...
    lfcByteBuffer_t *tto = lfcByteBuffer_ctor();
    lfcByteBuffer_write_int16(tto, 125);

    should_be_same_int(lfcByteBuffer_read_int16(tto, NULL), 2);
...
Test(
    ...
    int16_t result = 0;
    lfcByteBuffer_t *tto = lfcByteBuffer_ctor();
    lfcByteBuffer_write_int16(tto, 1145);

    lfcByteBuffer_read_int16(tto, &result);
