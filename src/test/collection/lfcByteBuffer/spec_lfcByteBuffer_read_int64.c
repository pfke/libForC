...
#define TEST_SUITE_NAME               spec_lfcByteBuffer_read_int64
...
Test(
    ...
    should_be_same_int(lfcByteBuffer_read_int64(tto, NULL), 0);
...
Test(
    ...
    lfcByteBuffer_t *tto = lfcByteBuffer_ctor();
    lfcByteBuffer_write_int64(tto, 125);

    should_be_same_int(lfcByteBuffer_read_int64(tto, NULL), 8);
...
Test(
    ...
    int64_t result = 0;
    lfcByteBuffer_t *tto = lfcByteBuffer_ctor();
    lfcByteBuffer_write_int64(tto, 1145);

    lfcByteBuffer_read_int64(tto, &result);
